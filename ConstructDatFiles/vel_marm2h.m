...
function get_output = vel_marm2h(Nx,Ny)
 tic
% clear all 
...
P = prolong2D(NxOrig*2,NyOrig*2); 
Nxh8 = NxOrig*2; Nyh8 = NyOrig*2; 
trim_vel_vec_h2 = P*trim_vel_vec; clear R;

trim_vel_mat_h2 = reshape(trim_vel_vec_h2,Nxh8 +1,Nyh8 +1); 

trim_vel_mat_required = trim_vel_mat_h2; 
trim_vel_vec_required = trim_vel_vec_h2; 
