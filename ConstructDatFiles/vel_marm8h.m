% vel_marm.m   for h = 4 and h = 8

function get_output = vel_marm8h(Nx,Ny)
 tic
% clear all 
...
trim_vel_mat_required = trim_vel_mat_h8; 
trim_vel_vec_required = trim_vel_vec_h8; 
...
get_output = reshape(knew1,(Nxh8 +1)*(Nyh8 +1),1); 
